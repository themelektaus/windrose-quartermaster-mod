...
link /nologo /DLL /MACHINE:X64 /OUT:dxgi.dll /DEF:passthrough.def ^
    ...
    qm_log.obj qm_ue.obj qm_scan.obj qm_alloc.obj qm_crash.obj qm_config.obj qm_inject.obj qm_diag.obj qm_hook.obj qm_weather.obj qm_killxp.obj qm_shanty.obj qm_deposit.obj qm_itemgrant.obj qm_loot.obj ^
