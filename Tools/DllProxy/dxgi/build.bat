...
cl %COMMON_FLAGS% /EHa main.cpp qm_log.cpp qm_ue.cpp qm_scan.cpp qm_crash.cpp qm_inject.cpp qm_diag.cpp qm_hook.cpp
...
link /nologo /DLL /MACHINE:X64 /OUT:dxgi.dll ^
    main.obj qm_log.obj qm_ue.obj qm_scan.obj qm_crash.obj qm_inject.obj qm_diag.obj qm_hook.obj ^
