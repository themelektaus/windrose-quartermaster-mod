...
echo [build] cl /c main.cpp + qm_ue.cpp + qm_scan.cpp ...
cl %COMMON_FLAGS% /EHa main.cpp qm_ue.cpp qm_scan.cpp
...
link /nologo /DLL /MACHINE:X64 /OUT:dxgi.dll ^
    main.obj qm_ue.obj qm_scan.obj buffer.obj hook.obj trampoline.obj hde64.obj ^
